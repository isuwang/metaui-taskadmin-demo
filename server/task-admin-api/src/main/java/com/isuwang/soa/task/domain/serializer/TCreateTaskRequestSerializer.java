 package com.isuwang.soa.task.domain.serializer;
        ...
        *  @generated
        **/
        public class TCreateTaskRequestSerializer implements TCommonBeanSerializer<com.isuwang.soa.task.domain.TCreateTaskRequest>{
        
      @Override
      public com.isuwang.soa.task.domain.TCreateTaskRequest read(TProtocol iprot) throws TException{

        com.isuwang.soa.task.domain.TCreateTaskRequest bean = new com.isuwang.soa.task.domain.TCreateTaskRequest();
        ...
        iprot.readListEnd();
          bean.setImprovements(Optional.of(elem0));
              ...
              case 22:
                ...
                com.isuwang.soa.task.domain.TAttachment elem0 = new com.isuwang.soa.task.domain.TAttachment();
        elem0=new com.isuwang.soa.task.domain.serializer.TAttachmentSerializer().read(iprot);
          bean.setAttachment(Optional.of(elem0));
                }else{
                     com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
                }
                break;
      ...
      @Override
      public void write(com.isuwang.soa.task.domain.TCreateTaskRequest bean, TProtocol oprot) throws TException{
      ...
      if(bean.getParentTaskId().isPresent()){
              ...
              Integer elem0 = bean.getParentTaskId().get();
          ...
          oprot.writeListEnd();
            ...
            if(bean.getAttachment().isPresent()){
              oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("attachment", com.isuwang.org.apache.thrift.protocol.TType.STRUCT, (short) 22));
              com.isuwang.soa.task.domain.TAttachment elem14 = bean.getAttachment().get();
               new com.isuwang.soa.task.domain.serializer.TAttachmentSerializer().write(elem14, oprot);
              
            }
            if(bean.getRemark().isPresent()){
              oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("remark", com.isuwang.org.apache.thrift.protocol.TType.STRING, (short) 23));
              String elem15 = bean.getRemark().get();
      ...
      public void validate(com.isuwang.soa.task.domain.TCreateTaskRequest bean) throws TException{
      
              if(bean.getTaskSubject() == null)
              throw new SoaException(SoaBaseCode.NotNull, "taskSubject字段不允许为空");
            
                if(bean.getAttachment().isPresent())
                new com.isuwang.soa.task.domain.serializer.TAttachmentSerializer().validate(bean.getAttachment().get());
              
    }
    
        @Override
        public String toString(com.isuwang.soa.task.domain.TCreateTaskRequest bean)
