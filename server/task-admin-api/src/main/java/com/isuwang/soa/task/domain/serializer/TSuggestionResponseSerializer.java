 package com.isuwang.soa.task.domain.serializer;
        ...
        *  @generated
        **/
        public class TSuggestionResponseSerializer implements TCommonBeanSerializer<com.isuwang.soa.task.domain.TSuggestionResponse>{
        
      @Override
      public com.isuwang.soa.task.domain.TSuggestionResponse read(TProtocol iprot) throws TException{

        com.isuwang.soa.task.domain.TSuggestionResponse bean = new com.isuwang.soa.task.domain.TSuggestionResponse();
        ...
        java.util.List<com.isuwang.soa.task.domain.TSuggestion> elem0 = new java.util.ArrayList<>(_list0.size);
        for(int _i0 = 0; _i0 < _list0.size; ++ _i0){
          com.isuwang.soa.task.domain.TSuggestion elem1 = new com.isuwang.soa.task.domain.TSuggestion();
        elem1=new com.isuwang.soa.task.domain.serializer.TSuggestionSerializer().read(iprot);
          elem0.add(elem1);
        }
        iprot.readListEnd();
          bean.setRows(elem0);
      ...
      @Override
      public void write(com.isuwang.soa.task.domain.TSuggestionResponse bean, TProtocol oprot) throws TException{
      ...
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("TSuggestionResponse"));
            ...
            java.util.List<com.isuwang.soa.task.domain.TSuggestion> elem1 = bean.getRows();
          ...
          for(com.isuwang.soa.task.domain.TSuggestion elem2 : elem1){
           new com.isuwang.soa.task.domain.serializer.TSuggestionSerializer().write(elem2, oprot);
        }
          oprot.writeListEnd();
      ...
      public void validate(com.isuwang.soa.task.domain.TSuggestionResponse bean) throws TException{
        ...
        @Override
        public String toString(com.isuwang.soa.task.domain.TSuggestionResponse bean)
