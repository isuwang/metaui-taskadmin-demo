 package com.isuwang.soa.scala.task.domain.serializer;
        ...
        **/
        ...
        class TCreateTaskRequestSerializer extends TCommonBeanSerializer[com.isuwang.soa.scala.task.domain.TCreateTaskRequest]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.isuwang.soa.scala.task.domain.TCreateTaskRequest = {
      ...
      var parentTaskId: Option[Int] = None
        ...
        var attachment: Option[com.isuwang.soa.scala.task.domain.TAttachment] = None
      ...
      while (schemeField == null || schemeField.`type` != com.isuwang.org.apache.thrift.protocol.TType.STOP) {
        ...
        _result0
              ...
              case 22 =>
                  schemeField.`type` match {
                    case com.isuwang.org.apache.thrift.protocol.TType.STRUCT => attachment = Option(new com.isuwang.soa.scala.task.domain.serializer.TAttachmentSerializer().read(iprot))
                    case _ => com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.`type`)
            }
      ...
      val bean = com.isuwang.soa.scala.task.domain.TCreateTaskRequest(parentTaskId = parentTaskId,`type` = `type`,status = status,businessTypeId = businessTypeId,priority = priority,taskSubject = taskSubject,companyId = companyId,communicationStyle = communicationStyle,planAt = planAt,handlerId = handlerId,problemDesc = problemDesc,resultDesc = resultDesc,questions = questions,improvements = improvements,attachment = attachment,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.isuwang.soa.scala.task.domain.TCreateTaskRequest, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("TCreateTaskRequest"))

      
            if(bean.parentTaskId.isDefined){
            val elem0 = bean.parentTaskId .get
        ...
        oprot.writeListEnd
            ...
            if(bean.attachment.isDefined){
            val elem14 = bean.attachment .get
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("attachment", com.isuwang.org.apache.thrift.protocol.TType.STRUCT, 22.asInstanceOf[Short]))
             new com.isuwang.soa.scala.task.domain.serializer.TAttachmentSerializer().write(elem14, oprot)
            oprot.writeFieldEnd
            
            }
            if(bean.remark.isDefined){
            val elem15 = bean.remark .get
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("remark", com.isuwang.org.apache.thrift.protocol.TType.STRING, 23.asInstanceOf[Short]))
      ...
      @throws[TException]
      override def validate(bean: com.isuwang.soa.scala.task.domain.TCreateTaskRequest): Unit = {
      
              if(bean.taskSubject == null)
              throw new SoaException(SoaBaseCode.NotNull, "taskSubject字段不允许为空")
            
                if(bean.attachment.isDefined)
                new com.isuwang.soa.scala.task.domain.serializer.TAttachmentSerializer().validate(bean.attachment.get)
              
    }
    

          @throws[TException]
          override def toString(bean: com.isuwang.soa.scala.task.domain.TCreateTaskRequest): String = if (bean == null) "null" else bean.toString
